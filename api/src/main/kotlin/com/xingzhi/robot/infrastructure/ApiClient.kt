package com.xingzhi.robot.infrastructure

import com.xingzhi.robot.auth.ApiKeyAuth
...
import com.xingzhi.robot.infrastructure.Serializer.kotlinxSerializationJson
...
class ApiClient(
    ...
    companion object {
        @JvmStatic
        protected val baseUrlKey = "com.xingzhi.robot.baseUrl"

        @JvmStatic
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(baseUrlKey, "http://10.147.19.177")
        }
    }
}
